...
val tweets = listOf(
    ...
    Tweets(
        ...
        userAccountHandle = "@yetanotherdev_",
        userProfilePic = R.drawable.yetanotherdev_,
        content = "I launched my first app in 2️⃣0️⃣1️⃣8️⃣" +
                "It gained around 5.5L+ downloads." +
                "A very basic concept app that i created just for fun. 🎉" +
                "Sad part: I lost the keystore file and can't update my app. 📱" +
...
val allProfiles = listOf(
    Profile(
        ...
        userAccountHandle = "@yetanotherdev_",
        userProfilePic = R.drawable.yetanotherdev_,
        userProfileDescription = "Self taught Android Developer 📚 Trying to be a better coder 📱" +
